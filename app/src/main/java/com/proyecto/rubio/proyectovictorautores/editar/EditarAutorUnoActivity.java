...
public class EditarAutorUnoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_autor_uno);

        rellenarArrays();

        AdaptadorListaAutores adapter = new AdaptadorListaAutores(this, nombreAutor, fechaNacimiento);
        lista=(ListView)findViewById(R.id.lista_edit_autor);
        lista.setAdapter(adapter);
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent ventanaEdicion = new Intent(getApplication(), EditarAutorDosActivity.class);
